...
/**
 * An extension to {@link SimplePatternCollector} that walk directories
 * recursively.
 *
 * @package SimpleTest
 * @subpackage UnitTester
 * @see SimplePatternCollector
 */
class RecursivePatternCollector extends SimplePatternCollector {
    /**
     *
     * @param string $pattern   Perl compatible regex to test name against
     *  See {@link http://us4.php.net/manual/en/reference.pcre.pattern.syntax.php PHP's PCRE}
     *  for full documentation of valid patterns.
     */
	function RecursivePatternCollector($pattern = '/_test.php$/') {
		parent::SimplePatternCollector($pattern);
	}
