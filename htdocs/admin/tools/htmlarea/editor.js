...
function editor_generate(objname,userConfig, handler) {
  ...
  + '</td></tr></table>\n'
  + '</td></tr></table></span>\n'
  + '<textarea ID="_' +objname + '_editor" style="width:' +config.width+ '; height:' +config.height+ '; margin-top: -1px; margin-bottom: -1px;" wrap=soft>cccc</textarea>';
...
function editor_setmode(objname, mode) {
 ...
 // src="' +_editor_url+ 'popups/blank.html"
  ...
  //
    ...
    html += '</style>\n';
    html += '<script src="js/handlers.js"></script>';
    html += '</head>\n'
